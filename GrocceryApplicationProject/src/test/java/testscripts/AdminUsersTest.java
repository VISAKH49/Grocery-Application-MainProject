...
public class AdminUsersTest extends Base {
	...
	public void verifyWhetherUserIsAbleToAddUserInAdminUsers() throws IOException {
		...
		adminsuserspage.clickOnNewButtonInAdminUsers().enterUsernameInAdminUsersInfo(AdminUsername)
				.enterPasswordInAdminUsersInfo(AdminPassword).selectUserTypeInAdminUsersInfo()
				.clickOnSaveButtonInAdminUserInfo();
	...
	public void verifyWhetherUserIsAbleToSearchAdminUsers() throws IOException {
		...
		adminsuserspage.clickOnSearchButtonInAdminUsers().enterUserNameInSearchAdminUsers(AdminSearchUsername)
				.selectUserTypeInSearchAdminUsers().clickOnSearchButtonAfterEnterValues();
